...
BTC_0_dic = {'type': 'type_0', 'coin_No': 0, 'coin_Name': 'KRW-BTC', 'ma_duration_long': 72, 'ma_duration_mid': 35, 'ma_duration_short': 7, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0001, 'successive_rise': 7, 'ratio_ema_mid_long': 0.99, 'ref_vol_duration': 4,              'diff_m_l_factor': 0.005, 'coe_vol_comp': 1.0, 'under_long_duration': 20, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.003, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

ETH_1_dic = {'type': 'type_0', 'coin_No': 1, 'coin_Name': 'KRW-ETH', 'ma_duration_long': 80, 'ma_duration_mid': 43, 'ma_duration_short': 10, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 11, 'ratio_ema_mid_long': 0.985, 'ref_vol_duration': 1.0,              'diff_m_l_factor': 0.005, 'coe_vol_comp': 1.0, 'under_long_duration': 20, 'recent_vol_duration': 10, 'sell_method_vol_cri': 1.0, 'ratio_peak_diff': 0.003, 'ratio_sell_forced': 0.15, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

WAVES_7_dic = {'type': 'type_0', 'coin_No': 7, 'coin_Name': 'KRW-WAVES', 'ma_duration_long': 95, 'ma_duration_mid': 37, 'ma_duration_short': 1, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 7, 'ratio_ema_mid_long': 0.99, 'ref_vol_duration': 1.5,                'diff_m_l_factor': 0.0, 'coe_vol_comp': 0.2, 'under_long_duration': 20, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.5, 'ratio_peak_diff': 0.0035, 'ratio_sell_forced': 0.07, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

STEEM_11_dic = {'type': 'type_0', 'coin_No': 11, 'coin_Name': 'KRW-STEEM', 'ma_duration_long': 70, 'ma_duration_mid': 37, 'ma_duration_short': 7, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 12, 'ratio_ema_mid_long': 0.985, 'ref_vol_duration': 1.5,                 'diff_m_l_factor': 0.0, 'coe_vol_comp': 0.2, 'under_long_duration': 25, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.2,  'ratio_peak_diff': 0.003, 'ratio_sell_forced': 0.07, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

XRP_4_dic = {'type': 'type_0', 'coin_No': 4, 'coin_Name': 'KRW-XRP', 'ma_duration_long': 65, 'ma_duration_mid': 38, 'ma_duration_short': 7, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 5, 'ratio_ema_mid_long': 0.99, 'ref_vol_duration': 2,              'diff_m_l_factor': 0.0, 'coe_vol_comp': 0.2, 'under_long_duration': 20, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.0055, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

HIVE_67_dic = {'type': 'type_0', 'coin_No': 67, 'coin_Name': 'KRW-HIVE', 'ma_duration_long': 72, 'ma_duration_mid': 35, 'ma_duration_short': 2, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0005, 'successive_rise': 9, 'ratio_ema_mid_long': 0.99, 'ref_vol_duration': 1,                'diff_m_l_factor': 0, 'coe_vol_comp': 1.0, 'under_long_duration': 18, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.3, 'ratio_peak_diff': 0.004, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}




ETC_5_dic = {'type': 'type_2', 'coin_No': 5, 'coin_Name': 'KRW-ETC', 'ma_duration_long': 102, 'ma_duration_mid': 30, 'ma_duration_short': 72, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99,              'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 30, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.5, 'ratio_peak_diff': 0.006, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0}

BTG_20_dic = {'type': 'type_2', 'coin_No': 20, 'coin_Name': 'KRW-BTG', 'ma_duration_long': 102, 'ma_duration_mid': 32, 'ma_duration_short': 50, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 5, 'ratio_ema_mid_long': 0.985,               'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 1.0, 'under_long_duration': 20, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.7, 'ratio_peak_diff': 0.015, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

ARK_14_dic = {'type': 'type_2', 'coin_No': 14, 'coin_Name': 'KRW-ARK', 'ma_duration_long': 91, 'ma_duration_mid': 27, 'ma_duration_short': 63, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98,               'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 40, 'recent_vol_duration': 12, 'sell_method_vol_cri': 0.6, 'ratio_peak_diff': 0.006, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

WAXP_57_dic = {'type': 'type_2', 'coin_No': 57, 'coin_Name': 'KRW-WAXP', 'ma_duration_long': 104, 'ma_duration_mid': 23, 'ma_duration_short': 67, 'ratio_ema_long_rise': 1.0,  'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99,                'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 37, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.3, 'ratio_peak_diff': 0.005, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0}
 
SSX_84_dic = {'type': 'type_2', 'coin_No': 84, 'coin_Name': 'KRW-SSX', 'ma_duration_long': 99, 'ma_duration_mid': 33, 'ma_duration_short': 80, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 8,               'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 47, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.008, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0}

QTUM_9_dic = {'type': 'type_2', 'coin_No': 9, 'coin_Name': 'KRW-QTUM', 'ma_duration_long': 89, 'ma_duration_mid': 33, 'ma_duration_short': 77, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 10,               'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 39, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.4, 'ratio_peak_diff': 0.006, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}

BCH_30_dic = {'type': 'type_2', 'coin_No': 30, 'coin_Name': 'KRW-BCH', 'ma_duration_long': 103, 'ma_duration_mid': 30, 'ma_duration_short': 70, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8,               'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 49, 'recent_vol_duration': 8, 'sell_method_vol_cri': 0.7, 'ratio_peak_diff': 0.005, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}
...
LIST_target = [BTC_0_dic, ETH_1_dic, WAVES_7_dic, STEEM_11_dic, XRP_4_dic, HIVE_67_dic, ETC_5_dic, BTG_20_dic, ARK_14_dic, WAXP_57_dic, SSX_84_dic]
...
def type_0_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 0 :   # 매수가 없는 상태라면 
        ...
        if (DF_check['ratio_ema_long'][-3] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-2] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-1] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_mid'][-1] > target_dic['ratio_ema_mid_rise']) and         (DF_check.iloc[-(target_dic['successive_rise'] + 2) : ]['rise_check_short'].sum() >= (target_dic['successive_rise'] - 2)) and         ((DF_check['ema_mid'][-1] / DF_check['ema_long'][-1]) > target_dic['ratio_ema_mid_long']) and         (DF_check['ref_vol_amount'][-2] >= target_dic['coe_vol_comp']) and (DF_check['ref_vol_amount'][-2] >= DF_check['ref_vol_amount'][-3]) and (DF_check['ref_vol_amount'][-2] >= DF_check['ref_vol_amount'][-4]) and         (-DF_check.loc[DF_check.iloc[-(target_dic['under_long_duration'] + 1) : -1]['diff_m_l'].idxmin()]['diff_m_l'] > (target_dic['diff_m_l_factor'] * DF_check['open'][-1])) :
    ...
    if target_dic['bought_state'] == 1 :   # 매수가 되어 있는 상태라면
        ...
        time_slapse_bought = math.ceil(((current_time - target_dic['bought_time']).days * 24) + (current_time - target_dic['bought_time']).seconds / 3600)
        
        DF_check_peak = pyupbit.get_ohlcv(target_coin, count=round(time_slapse_bought + target_dic['ma_duration_long'] + 500), interval = candle_adapt)
        ...
        print('Cheking Peak_difference over criteria Loss with coin :', target_coin)
        ...
        print('((DF_check_peak.loc[DF_check_peak.iloc[-time_slapse_bought : ][ratio_ema_long].idxmax()][ratio_ema_long] - DF_check_peak[ratio_ema_long][-1] >  target_dic[ratio_peak_diff]) ____ {0} > {1}'.                     format((DF_check_peak.loc[DF_check_peak.iloc[-time_slapse_bought : ]['ratio_ema_long'].idxmax()]['ratio_ema_long'] - DF_check_peak['ratio_ema_long'][-1]), target_dic['ratio_peak_diff']))
        
        if (DF_check_peak['volume'][-2] < (target_dic['sell_method_vol_cri'] * DF_check_peak.iloc[(-5) : -2]['volume'].mean())) and         (time_slapse_bought > 1) and ((DF_check_peak.loc[DF_check_peak.iloc[-time_slapse_bought : ]['ratio_ema_long'].idxmax()]['ratio_ema_long'] - DF_check_peak['ratio_ema_long'][-1]) > target_dic['ratio_peak_diff']) :
...
while True:
    try:
        ...
        if (0 < (now.minute % time_unit) <= 3) & (0 < (now.second % 60) <= 59):  # N시:01:00초 ~ N시:01:59초 사이 시각이면
